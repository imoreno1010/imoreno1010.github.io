---
title: "Transformación de MER"
date: "2026-08-29T00:00:00-05:00"
description: "Las reglas para transformar un Modelo Entidad-Relación (MER)."
draft: false
categories:
  - "Evidencias"
tags:
  - "Modelado"
---
Después de construir un Modelo Entidad-Relación (MER), el siguiente paso es transformarlo aun manteniendo la manera de MER de Peter Chen.Estas son las reglas principales que estoy aprendiendo para hacer esa transformación.

<!-- more -->

## Las reglas de transformación

1. **Eliminación de atributos multivaluados** — un atributo que puede tener varios valores no puede quedar dentro de la misma entidad; hay que sacarlo y convertirlo en una entidad aparte, relacionada con la entidad original.
...
3. **Todas las entidades en el MER / Las entidades se mantienen** — como regla general, cada entidad del MER se mantiene, conservando sus atributos.

4. **Cardinalidad 1:1 con participación total en ambas entidades** — cuando ambas entidades participan siempre en la relación (participación total), se pueden fusionar en una sola entidad.
...
6. **Transformación para entidades con cardinalidad 1:M** — la llave primaria de la entidad del lado "1" se agrega como llave foránea en la entidad del lado "M".
...
8. **Transformación para entidades con cardinalidad N:M** — se necesita una nueva entidad intermedia (relación) que contenga las llaves primarias de ambas entidades como llaves foráneas.

9. **Relaciones n-arias** (relaciones entre 3 o más entidades) — también requieren una entidad intermedia que conecte las llaves primarias de todas las entidades participantes.
...
11. **Generalización/Especialización** — cuando hay una entidad general con subtipos (por ejemplo, "Empleado" con subtipos "Gerente" y "Vendedor"), hay varias estrategias posibles: una entidad para la entidad general y una para cada subtipo, o combinarlas según el caso.
...
Regla: la PK del lado "1" pasa como FK al lado "N" 
